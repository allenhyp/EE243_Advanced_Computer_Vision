...
re_img_1 = idwt2(a2,h2,v2,d2,'haar',M);
...
function amplitude_image = drop_high_f_compo(input_image)
    ...
    subplot(2,3,2), imshow(bright_spikes);
    % Exclude the central DC spike.  Everything from row 115 to 143.
    bright_spikes(115:143, :) = 0;
    subplot(2,3,3), imshow(bright_spikes);
